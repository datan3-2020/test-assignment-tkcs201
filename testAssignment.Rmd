...
```{r}
SMage <- tapply(youth$socialmedia, youth$i_age_dv, mean, na.rm = TRUE)
SMgender <- tapply(youth$socialmedia, youth$gender, mean, na.rm = TRUE)

barplot(SMage, 
        col = "red", 
        xlab = "Age", 
        ylab = "Proportion with social media")
...
barplot(tapply(youth$socialmedia, list(socialmedia$)))
```
